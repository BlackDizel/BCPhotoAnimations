...
public class PresenterProjectExportMediaCodec implements IPresenterProjectExportMediaCodec {
    ...
    public PresenterProjectExportMediaCodec() {
    ...
    public void onClickExport(String sFps, String sWidth, String sHeight) {
        ...
        navigator.startExportServiceMediaCodec(cacheProjectSelected.getProjectSelectedId(), width, height, fps);
    }
}
